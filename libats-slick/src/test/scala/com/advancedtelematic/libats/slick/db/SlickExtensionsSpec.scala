...
object SlickExtensionsSpec {
  ...
  implicit val objectStatusMapping: BaseColumnType[com.advancedtelematic.libats.slick.db.SlickExtensionsSpec.ObjectStatus.Value] = SlickEnumMapper.enumMapper(ObjectStatus)
